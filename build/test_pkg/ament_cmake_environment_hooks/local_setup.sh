...
: ${AMENT_CURRENT_PREFIX:="/home/anurag/test_ws/install/test_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_pkg/environment/library_path.sh"
